...
CREATE TABLE "invoice_items"(
    "id" INTEGER NOT NULL,
    "unique_price" DECIMAL(8, 2) NOT NULL,
...
ALTER TABLE
    "medical_histories_treatments" ADD CONSTRAINT "medical_histories_treatments_treatment_id_foreign" FOREIGN KEY("treatment_id") REFERENCES "treatments"("id");
ALTER TABLE
    "medical_histories_treatments" ADD CONSTRAINT "medical_histories_treatments_medical_history_id_foreign" FOREIGN KEY("medical_history_id") REFERENCES "medical_histories"("id");